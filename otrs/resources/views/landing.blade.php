...
<nav id="main-nav">
  ...
  <a href="{{ route('bookings.create') }}" class="nav-cta" style="display:inline-flex;align-items:center;gap:.45rem;">
  ...
  <div class="nav-auth-links" style="display:flex;gap:.75rem;align-items:center;margin-left:1rem;">
    @guest
      <a href="{{ route('login') }}" style="font-size:.88rem;font-weight:600;color:var(--teal);padding:.4rem .9rem;border-radius:50px;border:1.5px solid var(--teal);transition:.2s;" onmouseover="this.style.background='var(--teal)';this.style.color='#fff'" onmouseout="this.style.background='transparent';this.style.color='var(--teal)'">Login</a>
      <a href="{{ route('register') }}" style="font-size:.88rem;font-weight:600;color:#fff;background:var(--gold);padding:.4rem .9rem;border-radius:50px;border:1.5px solid var(--gold);transition:.2s;" onmouseover="this.style.background='#c4912e'" onmouseout="this.style.background='var(--gold)'">Register</a>
    @else
      <a href="{{ route('dashboard') }}" style="font-size:.88rem;font-weight:600;color:var(--teal);padding:.4rem .9rem;border-radius:50px;border:1.5px solid var(--teal);">Dashboard</a>
    @endguest
  </div>
