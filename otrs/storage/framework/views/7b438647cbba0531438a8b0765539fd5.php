...
<a href="<?php echo e(route('admin.trips.index')); ?>" class="back-link">
...
<div class="form-card">
  <div class="form-card-title"><?php echo e(isset($trip) ? 'Edit Trip' : 'Add New Trip'); ?></div>
  ...
  <?php if(isset($trip)): ?>
    <form method="POST" action="<?php echo e(route('admin.trips.update', $trip)); ?>">
    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
  <?php else: ?>
    <form method="POST" action="<?php echo e(route('admin.trips.store')); ?>">
    <?php echo csrf_field(); ?>
  <?php endif; ?>
      ...
      <div class="form-group">
        ...
        <div class="sel-wrap">
          <select name="origin_country" id="originSelect"
                  class="form-input <?php echo e($errors->has('origin_country') ? 'error' : ''); ?>"
                  onchange="updatePreview()" required>
            <option value="">Select country…</option>
            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($country); ?>" <?php echo e(old('origin_country', $trip->origin_country ?? '') === $country ? 'selected' : ''); ?>>
                <?php echo e($country); ?>
      ...
      <div class="form-group">
        ...
        <div class="sel-wrap">
          <select name="destination_country" id="destSelect"
                  class="form-input <?php echo e($errors->has('destination_country') ? 'error' : ''); ?>"
                  onchange="updatePreview()" required>
            <option value="">Select country…</option>
            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($country); ?>" <?php echo e(old('destination_country', $trip->destination_country ?? '') === $country ? 'selected' : ''); ?>>
                <?php echo e($country); ?>
      ...
      <div class="form-group">
        ...
        <div class="sel-wrap">
          <select name="status" class="form-input">
            <option value="active"   <?php echo e(old('status', $trip->status ?? 'active') === 'active'   ? 'selected' : ''); ?>>Active</option>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input type="text" name="operator" class="form-input"
               value="<?php echo e(old('operator', $trip->operator ?? '')); ?>"
      ...
      <div class="form-group">
        ...
        <input type="number" name="max_passengers"
               class="form-input <?php echo e($errors->has('max_passengers') ? 'error' : ''); ?>"
               value="<?php echo e(old('max_passengers', $trip->max_passengers ?? 50)); ?>"
               min="1" max="9999" required>
        <?php $__errorArgs = ['max_passengers'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="form-error"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div style="display:flex;gap:10px;margin-top:6px;align-items:center;">
      <button type="submit" class="btn-save"><?php echo e(isset($trip) ? 'Save Changes' : 'Create Trip'); ?></button>
      <a href="<?php echo e(route('admin.trips.index')); ?>" class="btn-cancel">Cancel</a>
    </div>
  </form>
</div>
...
updatePreview();
</script><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/admin/trips/form.blade.php ENDPATH**/ ?>