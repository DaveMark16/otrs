...
<div style="padding:2px 0 18px">
    ...
    <div class="breadcrumb">
        <a href="<?php echo e(route('payments.index')); ?>">Payments & Refunds</a> →
        <span><?php echo e($payment->transaction_ref ?? 'Payment Details'); ?></span>
    </div>

    
    <?php $s = $payment->status; ?>
    <div class="status-banner <?php echo e($s==='paid'?'banner-paid':($s==='refunded'?'banner-refunded':($s==='pending'?'banner-pending':'banner-failed'))); ?>">
        <?php if($s === 'paid'): ?>      ✓ Payment Successful
        <?php elseif($s === 'refunded'): ?> ↩ Refund Processed
        <?php elseif($s === 'pending'): ?>  ⏳ Payment Pending
        <?php else: ?>                      ✕ Payment Failed
        <?php endif; ?>
        <span style="margin-left:auto;font-size:11px;opacity:.7"><?php echo e(ucfirst($s)); ?></span>
    </div>
    ...
    <div class="grid2">
        ...
        <div>
            ...
            <div class="panel">
                ...
                <div class="detail-row">
                    ...
                    <span class="d-val mono"><?php echo e($payment->transaction_ref ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Booking Ref</span>
                    <span class="d-val mono"><?php echo e($payment->booking->reference_no ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Payment Method</span>
                    <span class="d-val" style="color:#ccc"><?php echo e(ucfirst($payment->method)); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Currency</span>
                    <span class="d-val"><?php echo e(strtoupper($payment->currency ?? 'PHP')); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Status</span>
                    <span class="d-val">
                        <span class="pill <?php echo e($s==='paid'?'pill-green':($s==='pending'?'pill-amber':($s==='failed'?'pill-red':($s==='refunded'?'pill-blue':'pill-gray')))); ?>">
                ...
                <div class="detail-row">
                    ...
                    <span class="d-val"><?php echo e($payment->attempts ?? 1); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Paid At</span>
                    <span class="d-val"><?php echo e($payment->paid_at ? $payment->paid_at->format('M d, Y h:i A') : '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Created</span>
                    <span class="d-val"><?php echo e($payment->created_at->format('M d, Y h:i A')); ?></span>
                </div>
            </div>
            ...
            <div class="panel">
                ...
                <div class="detail-row">
                    ...
                    <span class="d-val" style="color:#ccc"><?php echo e($payment->booking->schedule->trip->name ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Route</span>
                    <span class="d-val" style="color:#ccc">
                        <?php echo e($payment->booking->schedule->trip->origin ?? '?'); ?>

                        <?php if($payment->booking->schedule->trip->origin_country ?? null): ?>
                            <span style="color:#FF6044;font-size:10px">, <?php echo e($payment->booking->schedule->trip->origin_country); ?></span>
                        <?php endif; ?>
                        →
                        <?php echo e($payment->booking->schedule->trip->destination ?? '?'); ?>

                        <?php if($payment->booking->schedule->trip->destination_country ?? null): ?>
                            <span style="color:#FF6044;font-size:10px">, <?php echo e($payment->booking->schedule->trip->destination_country); ?></span>
                        <?php endif; ?>
                    </span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Operator</span>
                    <span class="d-val"><?php echo e($payment->booking->schedule->trip->operator ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Departure</span>
                    <span class="d-val"><?php echo e($payment->booking->schedule->departure_at?->format('M d, Y h:i A') ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Fare Class</span>
                    <span class="d-val"><?php echo e(ucfirst($payment->booking->schedule->fare_class ?? '—')); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Passengers</span>
                    <span class="d-val"><?php echo e($payment->booking->passenger_count ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Contact Email</span>
                    <span class="d-val" style="font-size:11px"><?php echo e($payment->booking->contact_email ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Booking Status</span>
                    <span class="d-val">
                        <?php $bs = $payment->booking->status ?? 'unknown'; ?>
                        <span class="pill <?php echo e($bs==='confirmed'||$bs==='ticketed'?'pill-green':($bs==='pending'?'pill-amber':($bs==='cancelled'?'pill-red':'pill-gray'))); ?>">
            ...
            <div class="panel">
                ...
                <div class="detail-row">
                    ...
                    <span class="d-val mono" style="color:#378add"><?php echo e($payment->refund_ref ?? '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Refund Date</span>
                    <span class="d-val"><?php echo e($payment->refund_date ? \Carbon\Carbon::parse($payment->refund_date)->format('M d, Y h:i A') : '—'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="d-key">Reason</span>
                    <span class="d-val" style="font-size:11px;max-width:240px;text-align:right"><?php echo e($payment->refund_reason ?? '—'); ?></span>
                </div>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div>
            ...
            <div class="panel" style="text-align:center;padding:28px 20px">
                ...
                <div class="amount-big">₱<?php echo e(number_format($payment->amount, 2)); ?></div>
                <div style="margin-top:12px;font-size:11px;color:#555">
                    <?php echo e($payment->booking->passenger_count ?? 1); ?> pax
                    &nbsp;×&nbsp;
                    ₱<?php echo e(number_format($payment->booking->schedule->base_fare ?? 0, 2)); ?> base fare
                </div>
                <div style="margin-top:16px">
                    <span class="pill <?php echo e($s==='paid'?'pill-green':($s==='refunded'?'pill-blue':($s==='pending'?'pill-amber':'pill-red'))); ?>" style="font-size:12px;padding:6px 16px">
            ...
            <?php if($payment->booking->tickets && $payment->booking->tickets->count() > 0): ?>
            <div class="panel">
                <div class="p-head">
                    <div class="p-icon" style="background:#4caf81">🎫</div>
                    <div>
                        <div class="p-title">Issued Tickets</div>
                        <div class="p-sub"><?php echo e($payment->booking->tickets->count()); ?> ticket(s) for this booking</div>
                    </div>
                </div>
                <?php $__currentLoopData = $payment->booking->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="ticket-row">
                    <div>
                        <div class="tkt-no"><?php echo e($ticket->ticket_no); ?></div>
                        <div class="tkt-name" style="margin-top:2px"><?php echo e($ticket->passenger_name); ?></div>
                    </div>
                    <div style="display:flex;align-items:center;gap:6px">
                        <span class="tkt-class <?php echo e($ticket->fare_class==='business'?'cls-biz':($ticket->fare_class==='first'?'cls-first':'cls-eco')); ?>">
                            <?php echo e(ucfirst($ticket->fare_class)); ?>

                        </span>
                        <span class="tkt-status <?php echo e($ticket->status==='issued'?'ts-issued':($ticket->status==='cancelled'?'ts-cancelled':'ts-used')); ?>">
            ...
            <div style="display:flex;gap:10px;justify-content:flex-end;flex-wrap:wrap">
                <a href="<?php echo e(route('payments.index')); ?>" class="btn-back">← Back to Payments</a>
                <a href="<?php echo e(route('bookings.show', $payment->booking->id)); ?>" class="btn-back" style="color:#378add;border-color:rgba(55,138,221,.3)">View Booking</a>
    ...
    <div class="modal">
        ...
        <div class="modal-info">
            <div class="modal-info-row">
                ...
                <span class="modal-info-v mono"><?php echo e($payment->transaction_ref); ?></span>
            </div>
            <div class="modal-info-row">
                <span class="modal-info-k">Booking Ref</span>
                <span class="modal-info-v mono"><?php echo e($payment->booking->reference_no); ?></span>
            </div>
            <div class="modal-info-row">
            ...
            <div class="modal-info-row">
                ...
                <span class="modal-info-v red">₱<?php echo e(number_format($payment->amount, 2)); ?></span>
            </div>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('payments.refund', $payment->id)); ?>">
            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                <div style="color:#e24b4a;font-size:11px;margin-top:4px"><?php echo e($message); ?></div>
            <?php unset($message);
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/payments/show.blade.php ENDPATH**/ ?>