...
<head>
    ...
    <title>OTRS — <?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></title>
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sb-user">
        <div class="sb-avatar"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'U', 0, 1))); ?></div>
        <div style="min-width:0;">
            <div class="sb-user-name"><?php echo e(auth()->user()->name ?? 'User'); ?></div>
...
<div class="main">
    <div class="topbar">
        ...
        <div class="topbar-right">
            ...
            <a href="<?php echo e(route('bookings.create')); ?>" class="topbar-btn">
                <svg viewBox="0 0 24 24"><path d="M17.8 19.2L16 11l3.5-3.5C21 6 21 4 19 4c-1 0-1.5.5-3.5 2.5L11 8.2 2.8 6.4 2 7.2l3 5.5-2 1.7v2.2l3-1.5 1.5 3h2.2l1.7-2 5.5 3z"/></svg>
                Book a Trip
            </a>
        </div>
...
</html><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/layouts/user.blade.php ENDPATH**/ ?>