  ...
  <div class="content">
    ...
    <div class="promo-banner">
      ...
      <div class="promo-banner-body">
        <div class="promo-banner-label">
          <?php echo e($activePromos->count() === 1 ? 'Active Promo' : $activePromos->count().' Active Promos'); ?> — save on your next booking
        </div>
        <div class="promo-banner-codes">
          <?php $__currentLoopData = $activePromos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="pbc"
              title="<?php echo e($ap->title ?? ''); ?> · <?php echo e($ap->formatted_discount ?? ''); ?> off"
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card teal">
        ...
        <div class="stat-value"><?php echo e($counts['total']); ?></div>
      ...
      <div class="stat-card gold">
        ...
        <div class="stat-value"><?php echo e($counts['pending']); ?></div>
      ...
      <div class="stat-card tan">
        ...
        <div class="stat-value"><?php echo e($counts['confirmed']); ?></div>
      ...
      <div class="stat-card red">
        ...
        <div class="stat-value"><?php echo e($counts['cancelled']); ?></div>
      ...
      <div class="panel">
        <div class="panel-head">
          <div class="panel-title">
            ...
            All Bookings
            <span style="font-size:.8rem;font-weight:500;color:rgba(59,42,26,.35);font-family:var(--ff-body);">(<?php echo e($bookings->total()); ?>)</span>
          </div>
          <a href="<?php echo e(route('bookings.create')); ?>" class="panel-link">+ New →</a>
        </div>
        ...
        <form method="GET" action="<?php echo e(route('bookings.index')); ?>">
          <div class="filter-bar">
            ...
            <select name="status" class="filter-select" onchange="this.form.submit()">
              ...
              <option value="ticketed"  <?php if(request('status')==='ticketed'): echo 'selected'; endif; ?>>Ticketed</option>
            ...
            <?php if(request('search') || request('status')): ?>
              <a href="<?php echo e(route('bookings.index')); ?>" class="btn-clear">Clear</a>
            <?php endif; ?>
          </div>
        </form>
        ...
        <div class="panel-body" style="padding-top:0;">
            ...
            <div class="booking-item">
              <div class="booking-route-wrap" style="flex:1;min-width:0;">
                ...
                <div style="min-width:0;">
                  <div class="booking-route">
                    <?php echo e($trip->origin_country ?? ($trip->origin ?? '?')); ?>

                    → <?php echo e($trip->destination_country ?? ($trip->destination ?? '?')); ?>

                  </div>
                  <div class="booking-date"><?php echo e($sched?->departure_at?->format('M d, Y · h:i A') ?? '—'); ?></div>
                  <div class="booking-ref"><?php echo e($booking->reference_no); ?></div>
                </div>
              </div>
              ...
              <div style="display:flex;align-items:center;gap:10px;flex-shrink:0;">
                ...
                <div class="booking-actions">
                  <a href="<?php echo e(route('bookings.show', $booking)); ?>" class="btn-act" title="View">
                    <svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                  </a>

                  <?php if($booking->status === 'confirmed'): ?>
                  <form method="POST" action="<?php echo e(route('bookings.pay', $booking)); ?>"
                        onsubmit="return confirm('Confirm payment for <?php echo e($booking->reference_no); ?>?')">
                    <?php echo csrf_field(); ?>
                  ...
                  <a href="<?php echo e(route('bookings.edit', $booking)); ?>" class="btn-act" title="Edit">
                    <svg viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                  </a>
                  <?php endif; ?>

                  <?php if($booking->status === 'ticketed'): ?>
                  <a href="<?php echo e(route('bookings.receipt', $booking)); ?>" class="btn-act" title="Receipt">
                    <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                  </a>
                  <?php endif; ?>

                  <?php if(!in_array($booking->status, ['cancelled','ticketed'])): ?>
                  <form method="POST" action="<?php echo e(route('bookings.destroy', $booking)); ?>"
                        onsubmit="return confirm('Cancel <?php echo e($booking->reference_no); ?>? This cannot be undone.')">
          ...
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="empty">
              ...
              No bookings found.
              <br>
              <a href="<?php echo e(route('bookings.create')); ?>" class="empty-cta">
        ...
        <div class="pag-wrap">
          <span class="pag-info">Showing <?php echo e($bookings->firstItem()); ?>–<?php echo e($bookings->lastItem()); ?> of <?php echo e($bookings->total()); ?></span>
          <div class="pag-links">
            <?php if($bookings->onFirstPage()): ?>
              <span class="disabled">‹</span>
            <?php else: ?>
              <a href="<?php echo e($bookings->previousPageUrl()); ?>">‹</a>
            <?php endif; ?>
            <?php $__currentLoopData = range(1, $bookings->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if($p === $bookings->currentPage()): ?>
                <span class="active"><?php echo e($p); ?></span>
              <?php else: ?>
                <a href="<?php echo e($bookings->url($p)); ?>"><?php echo e($p); ?></a>
              <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($bookings->hasMorePages()): ?>
              <a href="<?php echo e($bookings->nextPageUrl()); ?>">›</a>
            <?php else: ?>
              <span class="disabled">›</span>
            <?php endif; ?>
          </div>
...
</html><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/bookings/index.blade.php ENDPATH**/ ?>