...
<head>
    ...
    <title><?php echo e(config('app.name', 'OTRS')); ?> — Sign In</title>
...
<div class="login-card">
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="role-row">
            <?php $__currentLoopData = ['traveler','business','tourist','corporate','admin']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="role-btn <?php echo e($role === 'traveler' ? 'active' : ''); ?>"
                     onclick="setRole(this, '<?php echo e($role); ?>')">
...
<?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/auth/login.blade.php ENDPATH**/ ?>