...
Route::middleware(['auth', 'role:admin,superadmin'])
    ...
    ->group(function () {
        ...
        // Admin — Book a Trip on behalf of a user
        Route::get('/book-trip', [App\Http\Controllers\Admin\AdminBookingController::class, 'bookTrip'])
            ->name('book-trip');
        Route::get('/book-trip/{schedule}', [App\Http\Controllers\Admin\AdminBookingController::class, 'bookTripForm'])
            ->name('book-trip.form');
        Route::post('/book-trip/{schedule}', [App\Http\Controllers\Admin\AdminBookingController::class, 'bookTripStore'])
            ->name('book-trip.store');
        ...
        Route::patch('/users/{user}/toggle', [App\Http\Controllers\Admin\AdminUserController::class, 'toggle'])
            ->name('users.toggle');
        // Route::patch('/users/{user}/role', ...) removed — role is set at registration and cannot be changed
