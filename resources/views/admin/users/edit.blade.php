...
<style>
  ...
  .role-readonly svg { width: 14px; height: 14px; stroke: currentColor; fill: none; stroke-width: 2; flex-shrink: 0; opacity: .7; }
  .role-readonly-note {
    font-size: .7rem; color: rgba(59,42,26,.35);
    margin-top: 5px; display: flex; align-items: center; gap: 4px;
  }
  .role-readonly-note svg { width: 11px; height: 11px; stroke: currentColor; fill: none; stroke-width: 2; }
