...
<div class="dash">
  ...
  <div class="welcome-banner">
    <div class="welcome-left">
      ...
      <div class="welcome-name">Welcome back, <?php echo e(auth()->user()->name ?? 'Administrator'); ?></div>
      <div class="welcome-sub"><?php echo e(now()->format('l, F j, Y')); ?> &mdash; Here's what's happening with OTRS today.</div>
    </div>
    <div class="welcome-right">
      <div class="wstat">
        <div class="wstat-val"><?php echo e($stats['pending']); ?></div>
        <div class="wstat-label">Pending</div>
      </div>
      <div class="wstat">
        <div class="wstat-val"><?php echo e($stats['total_trips']); ?></div>
        <div class="wstat-label">Active Trips</div>
      </div>
      <div class="wstat">
        <div class="wstat-val"><?php echo e($stats['total_users']); ?></div>
  ...
  <div class="kpi-grid">
    <div class="kpi" style="--kpi-color:#2d6e6e; --kpi-bg:rgba(45,110,110,.09)">
      ...
      <div class="kpi-top">
        ...
        <span class="kpi-badge"><?php echo e($stats['admins']); ?> admin<?php echo e($stats['admins'] != 1 ? 's' : ''); ?></span>
      </div>
      <div class="kpi-label">Total Users</div>
      <div class="kpi-value"><?php echo e(number_format($stats['total_users'])); ?></div>
    ...
    <div class="kpi" style="--kpi-color:#d4a254; --kpi-bg:rgba(212,162,84,.10)">
      ...
      <div class="kpi-value"><?php echo e(number_format($stats['total_bookings'])); ?></div>
    ...
    <div class="kpi" style="--kpi-color:#2d6e6e; --kpi-bg:rgba(45,110,110,.09)">
      ...
      <div class="kpi-value" style="font-size:1.5rem;">&#8369;<?php echo e(number_format($stats['total_revenue'], 0)); ?></div>
    ...
    <div class="kpi" style="--kpi-color:#1a6060; --kpi-bg:rgba(26,96,96,.08)">
      ...
      <div class="kpi-value" style="font-size:1.5rem;">&#8369;<?php echo e(number_format($stats['paid_payments'], 0)); ?></div>
  ...
  <div class="status-row">
    <div class="scard" style="--sc-color:#a07830; --sc-bg:rgba(160,120,48,.10)">
      ...
      <div class="scard-info">
        ...
        <div class="scard-val"><?php echo e($stats['pending']); ?></div>
      </div>
      <a href="<?php echo e(route('admin.bookings.index', ['status'=>'pending'])); ?>" class="view-btn" style="align-self:center;">
        View
    ...
    <div class="scard" style="--sc-color:#2d6e6e; --sc-bg:rgba(45,110,110,.09)">
      ...
      <div class="scard-info">
        ...
        <div class="scard-val"><?php echo e($stats['confirmed']); ?></div>
      </div>
      <a href="<?php echo e(route('admin.bookings.index', ['status'=>'confirmed'])); ?>" class="view-btn" style="align-self:center;">
        View
        <svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg>
      </a>
    </div>
    ...
    <div class="scard" style="--sc-color:#b44444; --sc-bg:rgba(180,68,68,.08)">
      ...
      <div class="scard-info">
        ...
        <div class="scard-val"><?php echo e($stats['cancelled']); ?></div>
      </div>
      <a href="<?php echo e(route('admin.bookings.index', ['status'=>'cancelled'])); ?>" class="view-btn" style="align-self:center;">
        View
        <svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg>
      </a>
    </div>
    ...
    <div class="panel">
      <div class="panel-head">
        <div class="panel-title-wrap">
          ...
          <span class="panel-count"><?php echo e($recent_bookings->count()); ?></span>
        </div>
        <a href="<?php echo e(route('admin.bookings.index')); ?>" class="panel-link">
          View all
      ...
      <table class="btable">
        ...
        <tbody>
          ...
          <tr>
            <td><span class="ref"><?php echo e($b->reference_no); ?></span></td>
            <td>
              <div class="pax-chip">
                <div class="pax-av"><?php echo e(strtoupper(substr($b->user->name ?? 'U', 0, 2))); ?></div>
                <span class="pax-name"><?php echo e($b->user->name ?? '—'); ?></span>
              </div>
            </td>
            <td>
              <span class="route">
                <?php echo e($b->schedule->trip->origin ?? '?'); ?>

                <span class="route-arrow">→</span>
                <?php echo e($b->schedule->trip->destination ?? '?'); ?>

              </span>
            </td>
            <td>
              <?php $bs = $b->status; ?>
              <span class="pill pill-<?php echo e($bs); ?>"><?php echo e(ucfirst($bs)); ?></span>
            </td>
            <td><span class="amount">&#8369;<?php echo e(number_format($b->total_amount, 2)); ?></span></td>
            <td>
              <a href="<?php echo e(route('admin.bookings.show', $b)); ?>" class="view-btn">
    ...
    <div class="right-col">
        ...
        <div class="rev-row">
          ...
          <div class="rev-item">
            <div class="rev-label-row">
              <span class="rev-label-text"><?php echo e($bar['label']); ?></span>
              <span class="rev-label-val"><?php echo e($bar['val']); ?> <span style="font-weight:400;color:rgba(59,42,26,.35)">(<?php echo e(round($bar['val']/$total*100)); ?>%)</span></span>
            </div>
            <div class="rev-track">
              <div class="rev-fill" style="width:<?php echo e(round($bar['val']/$total*100)); ?>%; background:<?php echo e($bar['color']); ?>;"></div>
            </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      ...
      <div class="panel">
        <div class="panel-head">
          ...
          <a href="<?php echo e(route('admin.users.index')); ?>" class="panel-link">
            View all
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="9 18 15 12 9 6"/></svg>
          </a>
        </div>
        <?php $__empty_1 = true; $__currentLoopData = $recent_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="user-row">
          <div class="u-av"><?php echo e(strtoupper(substr($u->name, 0, 2))); ?></div>
          <div class="u-info">
            <div class="u-name"><?php echo e($u->name); ?></div>
            <div class="u-email"><?php echo e($u->email); ?></div>
          </div>
          <span class="pill <?php echo e(in_array($u->role, ['admin','superadmin']) ? 'pill-confirmed' : 'pill-pending'); ?>">
