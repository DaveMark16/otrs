...
<p class="page-subtitle">Reference #<?php echo e($booking->reference_no); ?> · <?php echo e($dep ? $dep->format('F j, Y') : '—'); ?></p>
...
<div class="route-hero">
  <div class="route-inner">
    ...
    <div class="route-mid">
      <div class="dur-badge">⏱ <?php echo e($durStr); ?></div>
      <div class="route-line"></div>
      <div style="font-size:.7rem;color:rgba(59,42,26,.32);">Direct · <?php echo e($trip->operator ?? 'N/A'); ?></div>
      <div class="fstats">
        <div><div class="fstat-label">Hours</div><div class="fstat-val"><?php echo e($hours); ?>h</div></div>
        <div><div class="fstat-label">Min</div><div class="fstat-val"><?php echo e($remMins); ?>m</div></div>
  ...
  <div>
    ...
    <div class="panel">
      ...
      <div class="panel-section">
        ...
        <div class="info-row"><span class="info-k">Airline / Operator</span><span class="info-v"><?php echo e($trip->operator ?? '—'); ?></span></div>
        <div class="info-row"><span class="info-k">Fare Class</span><span class="info-v"><?php echo e(ucfirst($schedule->fare_class ?? 'Economy')); ?></span></div>
        ...
        <div class="info-row"><span class="info-k">Date Booked</span><span class="info-v"><?php echo e($booking->created_at->format('M d, Y')); ?></span></div>
      </div>
    </div>
  </div>
  ...
  <div>
    ...
    <div class="panel">
      <div class="panel-section">
        ...
        <div class="amount-box">
          <?php if($booking->has_promo ?? false): ?>
            <div class="amount-orig">₱<?php echo e(number_format($booking->original_amount ?? 0, 2)); ?></div>
          <?php endif; ?>
          ...
          <?php if($booking->has_promo ?? false): ?>
            <div class="promo-tag">
              🏷 <?php echo e($booking->promo->promo_code ?? ''); ?> — saved ₱<?php echo e(number_format($booking->discount_amount ?? 0, 2)); ?>
      ...
      <div class="panel-section">
        ...
        <div class="info-row"><span class="info-k">Transaction Ref</span><span class="info-v" style="font-size:.72rem;font-family:monospace;"><?php echo e($booking->payment->transaction_ref ?? '—'); ?></span></div>
      </div>
      <?php endif; ?>
        ...
        <div class="timeline">
          ...
          <div class="tl-step">
            ...
            <div class="tl-body">
              ...
              <div class="tl-sub"><?php echo e($booking->created_at->format('M d, Y · h:i A')); ?></div>
            </div>
          </div>
          
          <div class="tl-step">
            <div class="tl-dot <?php echo e(in_array($s, ['confirmed','ticketed']) ? 'tl-dot-done' : ($s === 'pending' ? 'tl-dot-active' : 'tl-dot-wait')); ?>">
              <?php if(in_array($s, ['confirmed','ticketed'])): ?>
                <svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>
            ...
            <div class="tl-body">
              ...
              <div class="tl-sub"><?php echo e(in_array($s, ['confirmed','ticketed']) ? 'Approved' : ($s === 'pending' ? 'Pending review' : 'Rejected')); ?></div>
            </div>
          </div>
          
          <div class="tl-step">
            <div class="tl-dot <?php echo e($s === 'ticketed' ? 'tl-dot-done' : (($s === 'confirmed' && !$booking->payment) ? 'tl-dot-active' : 'tl-dot-wait')); ?>">
              <?php if($s === 'ticketed'): ?>
                <svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>
              <?php elseif($s === 'confirmed' && !$booking->payment): ?>
                <svg viewBox="0 0 24 24"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
            ...
            <div class="tl-body">
              ...
              <div class="tl-sub"><?php echo e($s === 'ticketed' ? 'Paid · ₱'.number_format($booking->total_amount,2) : ($s === 'confirmed' && !$booking->payment ? 'Awaiting payment' : 'Not yet due')); ?></div>
            </div>
          </div>
          
          <div class="tl-step">
            <div class="tl-dot <?php echo e($s === 'ticketed' ? 'tl-dot-done' : 'tl-dot-wait'); ?>">
              <?php if($s === 'ticketed'): ?>
                <svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>
              <?php else: ?>
            ...
            <div class="tl-body">
              ...
              <div class="tl-sub"><?php echo e($s === 'ticketed' ? 'Ready for download' : 'Pending payment'); ?></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="panel">
      ...
      <div class="panel-body">
        ...
        <?php elseif($s === 'confirmed' && !$booking->payment): ?>
          ...
          <div class="btn-group">
            <form method="POST" action="<?php echo e(route('bookings.pay', $booking->id)); ?>" style="display:inline" id="payForm"
                  onsubmit="return confirm('Pay ₱<?php echo e(number_format($booking->total_amount,2)); ?> via ' + document.getElementById('selectedMethod').value.replace(/_/g,' ') + '?')">
              <?php echo csrf_field(); ?>
        ...
        <?php elseif($s === 'cancelled'): ?>
          <a href="<?php echo e(route('bookings.create')); ?>" class="btn btn-pay">
...
document.addEventListener('DOMContentLoaded', function () {
  var oLat=<?php echo e($originCoords[0]); ?>,oLng=<?php echo e($originCoords[1]); ?>;
  var dLat=<?php echo e($destCoords[0]); ?>,dLng=<?php echo e($destCoords[1]); ?>;
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/bookings/show.blade.php ENDPATH**/ ?>