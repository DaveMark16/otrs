...
<?php $__env->startSection('page-title', 'My Tickets'); ?>
...
<div class="table-panel">
  <div class="panel-head">
    ...
    <?php if($tickets->count() > 0): ?>
      <span class="panel-count"><?php echo e($tickets->total()); ?> ticket<?php echo e($tickets->total() !== 1 ? 's' : ''); ?></span>
    <?php endif; ?>
  </div>
  ...
  <div style="overflow-x:auto;">
    <table class="ticket-table" id="ticket-table">
      ...
      <tbody>
        ...
        ?>
        <tr data-status="<?php echo e($ticket->status); ?>">
          
          <td><span class="ticket-no"><?php echo e($ticket->ticket_no ?? '—'); ?></span></td>

          
          <td>
            <div class="pax-chip">
              <div class="pax-av"><?php echo e($initials); ?></div>
              <span class="pax-name"><?php echo e($paxName); ?></span>
            </div>
          </td>
          ...
          <td>
            <div class="route-main">
              ...
              <?php if($originC): ?><span style="font-size:.7rem;color:var(--teal);font-weight:500;">, <?php echo e($originC); ?></span><?php endif; ?>
              →
              <?php echo e($dest); ?>

              <?php if($destC): ?><span style="font-size:.7rem;color:var(--teal);font-weight:500;">, <?php echo e($destC); ?></span><?php endif; ?>
            </div>
          </td>
          ...
          <td>
            <?php if($schedule && $schedule->departure_at): ?>
              <div style="font-weight:600;color:var(--brown);font-size:.82rem;"><?php echo e($schedule->departure_at->format('M d, Y')); ?></div>
              <div style="font-size:.72rem;color:rgba(59,42,26,.38);"><?php echo e($schedule->departure_at->format('h:i A')); ?></div>
            <?php else: ?>
              —
            <?php endif; ?>
          </td>
          ...
          <td><span class="seat-badge"><?php echo e($ticket->seat_no ?? '—'); ?></span></td>

          
          <td><span class="class-pill"><?php echo e(ucfirst($ticket->fare_class ?? 'Economy')); ?></span></td>

          
          <td>
            <span class="pill pill-<?php echo e($ticket->status); ?>"><?php echo e(ucfirst($ticket->status)); ?></span>
          </td>

          
          <td style="color:rgba(59,42,26,.42);font-size:.78rem;">
            <?php echo e($ticket->issued_at ? $ticket->issued_at->format('M d, Y') : '—'); ?>
          ...
          <td>
            <div class="action-group">
              <a href="<?php echo e(route('tickets.show', $ticket)); ?>" class="act-view">View</a>
              <?php if($ticket->status === 'issued'): ?>
                <span class="act-sep">·</span>
                <form method="POST" action="<?php echo e(route('tickets.cancel', $ticket)); ?>" style="display:inline"
  ...
  <div class="empty-state">
    ...
    <a href="<?php echo e(route('bookings.create')); ?>" class="btn-cta">
      <svg viewBox="0 0 24 24"><path d="M17.8 19.2L16 11l3.5-3.5C21 6 21 4 19 4c-1 0-1.5.5-3.5 2.5L11 8.2 2.8 6.4 2 7.2l3 5.5-2 1.7v2.2l3-1.5 1.5 3h2.2l1.7-2 5.5 3z"/></svg>
      Book a Trip
    </a>
  </div>
