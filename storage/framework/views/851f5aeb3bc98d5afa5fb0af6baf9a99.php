  ...
  <div class="content">
    ...
    <div class="stats-grid">
      <div class="stat-card teal">
        ...
        <div class="stat-value">₱<?php echo e(number_format($totalPaid ?? 0, 2)); ?></div>
      ...
      <div class="stat-card red">
        ...
        <div class="stat-value"><?php echo e($failedCount ?? 0); ?></div>
      ...
      <div class="stat-card tan">
        ...
        <div class="stat-value">₱<?php echo e(number_format($totalRefunded ?? 0, 2)); ?></div>
    ...
    <div class="panel">
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              ...
              <tr>
                ...
                <td><span class="ref-no"><?php echo e($payment->transaction_ref ?? $payment->id); ?></span></td>

                
                <td><span class="ref-no booking"><?php echo e($booking?->booking_ref ?? ($booking?->id ?? '—')); ?></span></td>

                
                <td>
                  <?php if($trip): ?>
                    <div class="route-main"><?php echo e($trip->origin ?? '?'); ?> → <?php echo e($trip->destination ?? '?'); ?></div>
                    <?php if($trip->origin_country ?? null): ?>
                      <div class="route-country"><?php echo e($trip->origin_country); ?> → <?php echo e($trip->destination_country ?? ''); ?></div>
                    <?php endif; ?>
                  <?php else: ?>
                ...
                <td>
                  <span class="amount-cell <?php echo e($st === 'refunded' ? 'refunded' : ''); ?>">
                ...
                <td>
                  <span class="method-pill">
                    ...
                    <?php echo e($payment->payment_method ?? 'GCash'); ?>

                  </span>
                </td>

                
                <td><span class="status-badge <?php echo e($stClass); ?>"><?php echo e(ucfirst($st)); ?></span></td>

                
                <td>
                  <?php if($payment->paid_at ?? null): ?>
                    <div class="date-main"><?php echo e(\Carbon\Carbon::parse($payment->paid_at)->format('M d, Y')); ?></div>
                    <div class="date-time"><?php echo e(\Carbon\Carbon::parse($payment->paid_at)->format('h:i A')); ?></div>
                  <?php else: ?>
                ...
                <td>
                  <?php if($payment->refunded_at ?? null): ?>
                    <div class="date-main"><?php echo e(\Carbon\Carbon::parse($payment->refunded_at)->format('M d, Y')); ?></div>
                    <div class="date-time"><?php echo e(\Carbon\Carbon::parse($payment->refunded_at)->format('h:i A')); ?></div>
                  <?php else: ?>
                    <span class="date-empty">—</span>
                  <?php endif; ?>
                </td>
                ...
                <td>
                  <div class="action-btns">
                    <a href="<?php echo e(route('payments.show', $payment)); ?>" class="btn-view">View</a>
                    <?php if($st === 'paid'): ?>
                      <form method="POST" action="<?php echo e(route('payments.refund', $payment)); ?>" onsubmit="return confirm('Request a refund for this payment?')">
              ...
              <tr>
                <td colspan="9">
                  <div class="empty">
                    ...
                    No transactions found. <a href="<?php echo e(route('bookings.create')); ?>" style="color:var(--teal);font-weight:600;">Book a trip to get started →</a>
                  </div>
                </td>
              </tr>
            <?php endif; ?>
      ...
      <?php if($payments instanceof \Illuminate\Pagination\LengthAwarePaginator && $payments->hasPages()): ?>
        <div class="pagination">
          <div class="pag-info">Showing <?php echo e($payments->firstItem()); ?>–<?php echo e($payments->lastItem()); ?> of <?php echo e($payments->total()); ?> transactions</div>
          <div class="pag-links">
            <a href="<?php echo e($payments->previousPageUrl() ?? '#'); ?>" class="pag-btn <?php echo e($payments->onFirstPage() ? 'disabled' : ''); ?>">‹</a>
            <?php $__currentLoopData = $payments->getUrlRange(1, $payments->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a href="<?php echo e($url); ?>" class="pag-btn <?php echo e($page === $payments->currentPage() ? 'active' : ''); ?>"><?php echo e($page); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($payments->nextPageUrl() ?? '#'); ?>" class="pag-btn <?php echo e(!$payments->hasMorePages() ? 'disabled' : ''); ?>">›</a>
          </div>
        </div>
      <?php endif; ?>
    </div>
...
</html><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/payments/index.blade.php ENDPATH**/ ?>