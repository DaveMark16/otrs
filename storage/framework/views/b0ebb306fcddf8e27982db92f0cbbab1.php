  ...
  <div class="content">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card gold">
        ...
        <div class="stat-value"><?php echo e($activePromos->filter(fn($p) => \Carbon\Carbon::parse($p->end_date)->diffInDays(now()) <= 7)->count()); ?></div>
      ...
      <div class="stat-card tan">
        ...
        <div class="stat-value"><?php echo e($promos->count()); ?></div>
      ...
      <div class="promo-card">
        <div class="promo-card-top">
          <div class="promo-card-header">
            <div class="promo-card-info">
              <div class="promo-card-title"><?php echo e($promo->title); ?></div>
              <?php if($promo->description): ?>
                <div class="promo-card-desc"><?php echo e($promo->description); ?></div>
              <?php endif; ?>
            </div>
            <div class="promo-discount-badge"><?php echo e($promo->formatted_discount ?? ($promo->discount_value . ($promo->discount_type === 'percentage' ? '%' : '₱'))); ?></div>
          </div>
          <div class="promo-code-box">
            <div>
              <div class="promo-code-label">Promo Code</div>
              <div class="promo-code-value"><?php echo e($promo->promo_code); ?></div>
            </div>
            <button class="promo-copy-btn"
              onclick="copyCode('<?php echo e($promo->promo_code); ?>', this)"
              title="Copy code">
        ...
        <div class="promo-card-bottom">
          <div class="promo-meta">
            <?php if($promo->applicable_to ?? null): ?>
              <span class="promo-tag">
                <svg viewBox="0 0 24 24"><path d="M17.8 19.2L16 11l3.5-3.5C21 6 21 4 19 4c-1 0-1.5.5-3.5 2.5L11 8.2 2.8 6.4 2 7.2l3 5.5-2 1.7v2.2l3-1.5 1.5 3h2.2l1.7-2 5.5 3z"/></svg>
                <?php echo e(ucfirst($promo->applicable_to)); ?>
          ...
          <div class="promo-expiry-row">
            <div class="promo-expiry">
              ...
              Expires <strong><?php echo e(\Carbon\Carbon::parse($promo->end_date)->format('M d, Y')); ?></strong>
            </div>
            <span class="promo-type-pill"><?php echo e(ucfirst($promo->discount_type ?? 'Percentage')); ?> off</span>
          </div>
          <a href="<?php echo e(route('bookings.create', ['promo' => $promo->promo_code])); ?>" class="promo-book-btn">
            <svg viewBox="0 0 24 24"><path d="M17.8 19.2L16 11l3.5-3.5C21 6 21 4 19 4c-1 0-1.5.5-3.5 2.5L11 8.2 2.8 6.4 2 7.2l3 5.5-2 1.7v2.2l3-1.5 1.5 3h2.2l1.7-2 5.5 3z"/></svg>
            Book &amp; Use This Code →
          </a>
        </div>
    ...
    <?php if($expiredPromos->isNotEmpty()): ?>
    <div class="section-head">
      <div>
    ...
    <div class="promo-grid">
      <?php $__currentLoopData = $expiredPromos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="promo-card expired">
        <div class="promo-card-top">
          <div class="promo-card-header">
            <div class="promo-card-info">
              <div class="promo-card-title" style="opacity:.55;"><?php echo e($promo->title); ?></div>
              <?php if($promo->description): ?>
                <div class="promo-card-desc"><?php echo e($promo->description); ?></div>
              <?php endif; ?>
            </div>
        ...
        <div class="promo-card-bottom">
          <div class="promo-expiry-row">
            <div class="promo-expiry" style="color:rgba(180,60,60,.6);">
              <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
              Expired <strong style="color:#b44444;"><?php echo e(\Carbon\Carbon::parse($promo->end_date)->format('M d, Y')); ?></strong>
            </div>
...
</html><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/promos/index.blade.php ENDPATH**/ ?>