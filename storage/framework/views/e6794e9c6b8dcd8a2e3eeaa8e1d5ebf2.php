...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sb-nav">
        ...
        <a href="<?php echo e(route('admin.book-trip')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.book-trip*') ? 'active' : ''); ?>" onclick="closeSidebar()">
...
</html><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>