...
<?php $__env->startSection('page-title', 'Ticket — ' . ($ticket->ticket_no ?? 'Details')); ?>
...
<a href="<?php echo e(route('tickets.index')); ?>" class="back-link">
...
<p class="page-subtitle">Full details for ticket <?php echo e($ticket->ticket_no ?? '—'); ?></p>
...
<div class="ticket-card">
  ...
  <div class="ticket-header">
    <div class="ticket-header-left">
      ...
      <div class="ticket-no-value"><?php echo e($ticket->ticket_no ?? '—'); ?></div>
    </div>
    <div class="ticket-status-badge"><?php echo e(ucfirst($ticket->status)); ?></div>
  </div>

  
  <div class="route-strip">
    <div class="route-city">
      <div class="route-city-code"><?php echo e(strtoupper(substr($origin, 0, 3))); ?></div>
      <div class="route-city-name"><?php echo e($origin); ?><?php echo e($originC ? ', '.$originC : ''); ?></div>
    </div>
    ...
    <div class="route-city">
      <div class="route-city-code"><?php echo e(strtoupper(substr($dest, 0, 3))); ?></div>
      <div class="route-city-name"><?php echo e($dest); ?><?php echo e($destC ? ', '.$destC : ''); ?></div>
    </div>
  </div>
  ...
  <div class="pax-section">
    ...
    <div class="pax-chip">
      <div class="pax-av"><?php echo e($initials); ?></div>
      <div class="pax-name"><?php echo e($paxName); ?></div>
    </div>
  </div>
  ...
  <div class="details-grid">
    <div class="detail-cell">
      ...
      <div class="detail-value">
        <?php if($schedule && $schedule->departure_at): ?>
          <?php echo e($schedule->departure_at->format('M d, Y')); ?><br>
          <span style="font-size:.78rem;color:rgba(59,42,26,.45);"><?php echo e($schedule->departure_at->format('h:i A')); ?></span>
        <?php else: ?>
          —
        <?php endif; ?>
      </div>
    ...
    <div class="detail-cell">
      ...
      <div class="detail-value mono"><?php echo e($ticket->seat_no ?? '—'); ?></div>
    </div>
    <div class="detail-cell">
      <div class="detail-label">Class</div>
      <div class="detail-value"><?php echo e(ucfirst($ticket->fare_class ?? 'Economy')); ?></div>
    </div>
    <div class="detail-cell">
      <div class="detail-label">Booking Ref</div>
      <div class="detail-value mono"><?php echo e($ticket->booking->booking_ref ?? '—'); ?></div>
    </div>
    <div class="detail-cell">
      <div class="detail-label">Issued At</div>
      <div class="detail-value">
        <?php echo e($ticket->issued_at ? $ticket->issued_at->format('M d, Y h:i A') : '—'); ?>

      </div>
    </div>
    <div class="detail-cell">
      <div class="detail-label">Passengers</div>
      <div class="detail-value"><?php echo e($ticket->booking->passenger_count ?? 1); ?> pax</div>
    </div>
  </div>
  ...
  <div class="ticket-footer">
    <span class="ticket-footer-note">
      Issued on <?php echo e($ticket->issued_at ? $ticket->issued_at->format('M d, Y') : '—'); ?>

    </span>
    <?php if($ticket->status === 'issued'): ?>
      <form method="POST" action="<?php echo e(route('tickets.cancel', $ticket)); ?>"
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/tickets/show.blade.php ENDPATH**/ ?>