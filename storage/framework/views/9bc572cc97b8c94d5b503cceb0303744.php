...
<div class="main">
  ...
  <div class="content">
    ...
    <div class="breadcrumb">
      ...
      <span class="breadcrumb-current"><?php echo e($payment->transaction_ref ?? 'Payment Details'); ?></span>
    </div>
    ...
    <div class="status-banner <?php echo e($s === 'paid' ? 'banner-paid' : ($s === 'refunded' ? 'banner-refunded' : ($s === 'pending' ? 'banner-pending' : 'banner-failed'))); ?>">
      ...
      <?php else: ?>
        ...
        Payment Failed
      <?php endif; ?>
      <span class="status-banner-label"><?php echo e(ucfirst($s)); ?></span>
    </div>
    ...
    <div class="detail-grid">
        ...
        <div class="panel">
          ...
          <div class="detail-rows">
            ...
            <div class="detail-row">
              ...
              <span class="d-val mono-tan"><?php echo e($payment->booking->reference_no ?? '—'); ?></span>
            </div>
            <div class="detail-row">
              <span class="d-key">Payment Method</span>
              <span class="d-val"><?php echo e(ucfirst($payment->method ?? '—')); ?></span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
              ...
              <span class="d-val">
                <span class="status-badge status-<?php echo e($s); ?>"><?php echo e(ucfirst($s)); ?></span>
              </span>
            </div>
            <div class="detail-row">
        ...
        <div class="panel">
          ...
          <div class="detail-rows">
            <div class="detail-row">
              ...
              <span class="d-val"><?php echo e($payment->booking->schedule->trip->name ?? '—'); ?></span>
            </div>
            <div class="detail-row">
              ...
              <span class="d-val">
                ...
                <?php if($payment->booking->schedule->trip->origin_country ?? null): ?>
                  <span style="color:rgba(59,42,26,.4);font-size:.78rem">, <?php echo e($payment->booking->schedule->trip->origin_country); ?></span>
                <?php endif; ?>
                →
                <?php echo e($payment->booking->schedule->trip->destination ?? '?'); ?>

                <?php if($payment->booking->schedule->trip->destination_country ?? null): ?>
                  <span style="color:rgba(59,42,26,.4);font-size:.78rem">, <?php echo e($payment->booking->schedule->trip->destination_country); ?></span>
                <?php endif; ?>
              </span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
              ...
              <span class="d-val" style="font-size:.82rem;"><?php echo e($payment->booking->contact_email ?? '—'); ?></span>
            </div>
            <div class="detail-row">
              <span class="d-key">Booking Status</span>
              <span class="d-val">
                <?php $bs = strtolower($payment->booking->status ?? 'unknown'); ?>
                <span class="status-badge status-<?php echo e(in_array($bs, ['paid','pending','refunded','failed','confirmed','cancelled','ticketed']) ? $bs : 'pending'); ?>">
        ...
        <div class="panel">
          ...
          <div class="detail-rows">
            <div class="detail-row">
              ...
              <span class="d-val"><span class="refund-ref"><?php echo e($payment->refund_ref ?? '—'); ?></span></span>
            </div>
            <div class="detail-row">
              <span class="d-key">Refund Date</span>
              <span class="d-val"><?php echo e($payment->refund_date ? $payment->refund_date->format('M d, Y h:i A') : '—'); ?></span>
            </div>
            <div class="detail-row">
              <span class="d-key">Reason</span>
              <span class="d-val" style="font-size:.82rem;max-width:260px;text-align:right;line-height:1.5;"><?php echo e($payment->refund_reason ?? '—'); ?></span>
            </div>
          </div>
        </div>
        <?php endif; ?>
      ...
      <div>
        ...
        <div class="amount-panel">
          ...
          <div class="amount-value <?php echo e($s === 'refunded' ? 'refunded' : ($s === 'paid' ? 'paid' : '')); ?>">
          ...
          <div class="amount-status">
            <span class="status-badge status-<?php echo e($s); ?>" style="font-size:.8rem;padding:6px 18px;">
        ...
        <div class="panel">
          <div class="panel-head">
            ...
            <div>
              ...
              <div class="panel-sub-text"><?php echo e($payment->booking->tickets->count()); ?> ticket(s) for this booking</div>
            </div>
          </div>
          <div class="panel-divider"></div>
          <div class="ticket-list" style="padding-top:14px;">
            ...
            <div class="ticket-item">
              <div>
                ...
                <div class="ticket-name"><?php echo e($ticket->passenger_name); ?></div>
              </div>
              <div class="ticket-tags">
                <span class="fare-badge <?php echo e($ticket->fare_class === 'business' ? 'fare-biz' : ($ticket->fare_class === 'first' ? 'fare-first' : 'fare-eco')); ?>">
                  <?php echo e(ucfirst($ticket->fare_class ?? 'Economy')); ?>

                </span>
                <?php $ts = strtolower($ticket->status ?? 'issued'); ?>
                <span class="status-badge status-<?php echo e(in_array($ts, ['paid','pending','refunded','failed','confirmed','cancelled','ticketed']) ? $ts : 'pending'); ?>" style="font-size:.68rem;padding:3px 9px;">
                  <?php echo e(ucfirst($ts)); ?>
        ...
        <div class="action-row" style="margin-top: 6px;">
          <a href="<?php echo e(route('payments.index')); ?>" class="btn-back">
            <svg viewBox="0 0 24 24"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>
            Back
          </a>
          <?php if($payment->booking): ?>
          <a href="<?php echo e(route('bookings.show', $payment->booking->id)); ?>" class="btn-booking">
  ...
  <div class="modal">
    ...
    <div class="modal-info">
      ...
      <div class="modal-info-row">
        ...
        <span class="modal-info-v amount">₱<?php echo e(number_format($payment->amount, 2)); ?></span>
      </div>
    </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
        <div class="f-error"><?php echo e($message); ?></div>
      <?php unset($message);
...
</html><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/payments/show.blade.php ENDPATH**/ ?>