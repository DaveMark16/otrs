...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="sb-item" onclick="closeSidebar()">
      <svg viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
      Dashboard
    </a>
    <a href="<?php echo e(route('bookings.index')); ?>" class="sb-item" onclick="closeSidebar()">
      <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
      My Bookings
    </a>
    <a href="<?php echo e(route('tickets.index')); ?>" class="sb-item" onclick="closeSidebar()">
    ...
    <a href="<?php echo e(route('bookings.create')); ?>" class="sb-item active" onclick="closeSidebar()">
    ...
    <a href="<?php echo e(route('promos.index')); ?>" class="sb-item" onclick="closeSidebar()">
    ...
    <a href="<?php echo e(route('payments.index')); ?>" class="sb-item" onclick="closeSidebar()">
      <svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
      Payments &amp; Refunds
    </a>
    <div class="sb-section">Account</div>
    <a href="<?php echo e(route('profile.edit')); ?>" class="sb-item" onclick="closeSidebar()">
...
<div class="main">
  ...
  <div class="content">
    ...
    <form method="POST" action="<?php echo e(route('bookings.store')); ?>" id="bookingForm">
      <?php echo csrf_field(); ?>
      <input type="hidden" name="schedule_id"     id="hiddenScheduleId"     value="<?php echo e(old('schedule_id', $selectedSchedule?->id)); ?>">
      <input type="hidden" name="passenger_count" id="hiddenPassengerCount" value="1">
      <input type="hidden" name="promo_code"       id="hiddenPromoCode"      value="<?php echo e(old('promo_code')); ?>">
      ...
      <div class="booking-grid">
        ...
        <div class="panel">
          <div class="panel-head">
            <div class="panel-head-inner">
              ...
              <div>
                ...
                <div class="panel-head-sub"><?php echo e($schedules->count()); ?> flights available · prices per person</div>
              </div>
            </div>
          </div>
          ...
          <div class="search-bar">
            <div class="search-input-wrap">
              ...
              <input type="text" id="searchInput" placeholder="Search by destination, airline, route…"
                     value="<?php echo e(request('search')); ?>" oninput="filterFlights()">
            </div>
          ...
          <div class="flight-list" id="flightList">
            <?php $__empty_1 = true; $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              ...
              ?>
              <div class="flight-item <?php echo e(($selectedSchedule?->id == $schedule->id) ? 'selected' : ''); ?>"
                   id="flight-<?php echo e($schedule->id); ?>"
                   data-id="<?php echo e($schedule->id); ?>"
                   data-trip-id="<?php echo e($schedule->trip_id); ?>"
                   data-class="<?php echo e($fc); ?>"
                   data-origin="<?php echo e($trip->origin ?? ''); ?>"
                   data-destination="<?php echo e($trip->destination ?? ''); ?>"
                   data-origin-country="<?php echo e($trip->origin_country ?? ''); ?>"
                   data-dest-country="<?php echo e($trip->destination_country ?? ''); ?>"
                   data-operator="<?php echo e($trip->operator ?? ''); ?>"
                   data-fare="<?php echo e($schedule->base_fare ?? 0); ?>"
                   data-seats="<?php echo e($schedule->available_seats ?? 0); ?>"
                   data-departure="<?php echo e($schedule->departure_at?->format('M d, Y · h:i A') ?? '—'); ?>"
                ...
                <div class="fi-left">
                  <div class="fi-header">
                    ...
                    <div>
                      <div class="fi-route-name"><?php echo e($trip->origin_country ?? $trip->origin ?? '?'); ?> → <?php echo e($trip->destination_country ?? $trip->destination ?? '?'); ?></div>
                      <div class="fi-operator"><?php echo e($trip->operator ?? 'Unknown Airline'); ?></div>
                    </div>
                  </div>
                  <div class="fi-route-row">
                    <div>
                      <div class="fi-city"><?php echo e($trip->origin ?? '?'); ?></div>
                      <div class="fi-city-sub"><?php echo e($trip->origin_country ?? ''); ?></div>
                    </div>
                    <div class="fi-arrow">
                    ...
                    <div style="text-align:right;">
                      <div class="fi-city"><?php echo e($trip->destination ?? '?'); ?></div>
                      <div class="fi-city-sub"><?php echo e($trip->destination_country ?? ''); ?></div>
                    </div>
                  </div>
                  <div class="fi-meta">
                    <div class="fi-meta-item">
                      <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                      <?php echo e($schedule->departure_at?->format('M d, Y · h:i A') ?? '—'); ?>

                    </div>
                    <span class="fi-badge <?php echo e($fc); ?>"><?php echo e(ucfirst($fc)); ?></span>
                  </div>
                </div>
                <div class="fi-right">
                  <div class="fi-price-label">Price</div>
                  <div class="fi-price">₱<?php echo e(number_format($schedule->base_fare ?? 0, 0)); ?></div>
                  <div class="fi-price-sub">per person</div>
                  <div class="fi-seats"><?php echo e($schedule->available_seats ?? 0); ?> seats left</div>
                  <button type="button" class="fi-select-btn <?php echo e(($selectedSchedule?->id == $schedule->id) ? 'selected-btn' : ''); ?>">
                    <?php echo e(($selectedSchedule?->id == $schedule->id) ? '✓ Selected' : 'Select'); ?>
        ...
        <div class="summary-panel">
          <div class="panel">
            ...
            <div class="summary-empty" id="summaryEmpty" style="<?php echo e($selectedSchedule ? 'display:none' : ''); ?>">
              <div class="summary-empty-icon">✈</div>
              <div class="summary-empty-text">Select a flight to see your booking summary</div>
            </div>

            
            <div class="summary-flight <?php echo e($selectedSchedule ? 'visible' : ''); ?>" id="summaryFlight">
              <div class="sf-route" id="sfRoute">
                <?php echo e($selectedSchedule ? ($selectedSchedule->trip->origin_country ?? $selectedSchedule->trip->origin ?? '?') . ' → ' . ($selectedSchedule->trip->destination_country ?? $selectedSchedule->trip->destination ?? '?') : ''); ?>

              </div>
              <div class="sf-meta" id="sfDep"><?php echo e($selectedSchedule?->departure_at?->format('M d, Y · h:i A') ?? ''); ?></div>
              <div class="sf-operator" id="sfOp"><?php echo e($selectedSchedule?->trip->operator ?? ''); ?></div>
            </div>

            
            <div class="pax-section" id="paxSection" style="<?php echo e($selectedSchedule ? '' : 'display:none'); ?>">
            ...
            <div class="contact-section" id="contactSection" style="<?php echo e($selectedSchedule ? '' : 'display:none'); ?>">
              <div class="contact-label">Contact Email</div>
              <input type="email" name="contact_email" class="contact-input <?php $__errorArgs = ['contact_email'];
...
unset($__errorArgs, $__bag); ?>"
                     placeholder="<?php echo e(auth()->user()->email); ?>"
                     value="<?php echo e(old('contact_email', auth()->user()->email)); ?>">
              <?php $__errorArgs = ['contact_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="promo-error"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            </div>
            ...
            <div class="promo-section">
              ...
              <div class="promo-input-row">
                <input type="text" id="promoInput" class="promo-input" placeholder="Enter Code"
                       value="<?php echo e(old('promo_code')); ?>" oninput="this.value=this.value.toUpperCase()">
...
unset($__errorArgs, $__bag); ?>
              ...
              ?>
              <?php if($availPromos->isNotEmpty()): ?>
              <div class="available-promos-label" style="margin-top:12px;">Available Promos — Click to Apply</div>
              <div class="promo-chips">
                <?php $__currentLoopData = $availPromos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="promo-chip" onclick="fillPromo('<?php echo e($ap->promo_code); ?>')">
                  <div class="pc-left">
                    <div class="pc-code"><?php echo e($ap->promo_code); ?></div>
                    <div class="pc-name"><?php echo e($ap->title ?? 'Promo discount'); ?></div>
                  </div>
                  <div class="pc-right">
                    <span class="pc-discount"><?php echo e($ap->formatted_discount ?? ($ap->discount_value . ($ap->discount_type === 'percent' ? '%' : '') . ' off')); ?></span>
                    <?php if($ap->end_date): ?>
                    <span class="pc-expiry">Exp <?php echo e($ap->end_date->format('M d')); ?></span>
                    <?php endif; ?>
                  </div>
                </div>
            ...
            <div class="warning-banner" id="warningBanner" style="<?php echo e($selectedSchedule ? '' : 'display:none'); ?>">
            ...
            <div class="summary-actions">
              <a href="<?php echo e(route('bookings.index')); ?>" class="btn-cancel" style="display:flex;align-items:center;justify-content:center;">Cancel</a>
              <button type="submit" class="btn-confirm" id="confirmBtn" <?php echo e($selectedSchedule ? '' : 'disabled'); ?>>
                <svg viewBox="0 0 24 24"><path d="M17.8 19.2L16 11l3.5-3.5C21 6 21 4 19 4c-1 0-1.5.5-3.5 2.5L11 8.2 2.8 6.4 2 7.2l3 5.5-2 1.7v2.2l3-1.5 1.5 3h2.2l1.7-2 5.5 3z"/></svg>
                Confirm Booking
              </button>
            </div>
...
<script>
/* ── State ── */
let selectedId   = <?php echo e($selectedSchedule?->id ?? 'null'); ?>;
let paxCount     = 1;
let baseFare     = <?php echo e($selectedSchedule?->base_fare ?? 0); ?>;
let discount     = 0;
let activeClass  = 'all';
...
function applyPromo() {
  ...
  // AJAX validate
  const tripId = document.getElementById('hiddenScheduleId')?.value
    ? (document.querySelector(`.flight-item[data-id="${selectedId}"]`)?.dataset.tripId ?? 0)
    : 0;

  fetch('<?php echo e(route('bookings.check-promo')); ?>', {
    method: 'POST',
    headers: {
  ...
  .then(data => {
    if (data.valid) {
      discount = data.discount / paxCount;
      document.getElementById('hiddenPromoCode').value = code;
      okEl.textContent = '✓ ' + (data.message ?? 'Promo applied!') + ' — ' + (data.label ?? '');
      okEl.style.display = '';
      document.getElementById('pbDiscountRow').style.display = '';
      updatePrices();
    } else {
  ...
  .catch(() => {
    document.getElementById('hiddenPromoCode').value = code;
    okEl.textContent = '✓ Code saved — discount will be applied on confirmation.';
    okEl.style.display = '';
  });
}
...
<?php if($selectedSchedule): ?>
  document.getElementById('priceBreakdown').classList.add('visible');
  baseFare = <?php echo e($selectedSchedule->base_fare ?? 0); ?>;
  updatePrices();
<?php endif; ?>
</script>

</body>
</html><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/bookings/create.blade.php ENDPATH**/ ?>