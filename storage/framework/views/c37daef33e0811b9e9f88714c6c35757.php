...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="profile-card">
    ...
    <div class="info-row">
      ...
      <span class="info-value"><span class="info-badge"><?php echo e($user->role ?? 'Traveler'); ?></span></span>
    </div>
    <div class="info-row">
      <span class="info-label">Email Status</span>
      <span class="info-value" style="color:<?php echo e($user->email_verified_at ? 'var(--teal)' : '#b44444'); ?>;font-size:.78rem;font-weight:600;">
...
<div class="profile-panel" id="panel-password">
  <div class="profile-card">
    ...
    <?php if($errors->updatePassword->any()): ?>
      <div class="alert alert-error"><?php echo e($errors->updatePassword->first()); ?></div>
    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="profile-card">
    ...
    <div class="tip-row">
      <span class="tip-icon"><?php echo e($icon); ?></span>
      <span class="tip-text"><?php echo e($tip); ?></span>
    </div>
...
<div class="profile-panel" id="panel-account">
  <div class="profile-card">
    ...
    <div class="info-row">
      ...
      <span class="info-value" style="font-family:monospace;font-size:.78rem;color:rgba(59,42,26,.4);">#<?php echo e(str_pad($user->id, 6, '0', STR_PAD_LEFT)); ?></span>
    </div>
    <div class="info-row">
    ...
    <div class="info-row">
      ...
      <span class="info-value" style="font-size:.8rem;"><?php echo e($user->email); ?></span>
    </div>
    <div class="info-row">
...
<div class="modal-backdrop" id="deleteModal" onclick="handleModalBackdrop(event)">
  <div class="modal-box">
    ...
    <?php if($errors->userDeletion->any()): ?>
      <div class="alert alert-error"><?php echo e($errors->userDeletion->first()); ?></div>
    <?php endif; ?>
