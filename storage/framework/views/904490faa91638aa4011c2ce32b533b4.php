...
<div class="stats-strip">
  <div class="sstat">
    ...
    <div>
      ...
      <div class="sstat-val"><?php echo e($total); ?></div>
    </div>
  </div>
  <div class="sstat">
    ...
    <div>
      ...
      <div class="sstat-val"><?php echo e($active); ?></div>
    </div>
  </div>
  <div class="sstat">
    ...
    <div>
      ...
      <div class="sstat-val"><?php echo e($upcoming); ?></div>
    </div>
  </div>
  <div class="sstat">
    ...
    <div>
      ...
      <div class="sstat-val"><?php echo e($expired); ?></div>
    </div>
  </div>
</div>
...
<div class="toolbar">
  <div class="toolbar-left">
    <form method="GET" action="<?php echo e(route('admin.promos.index')); ?>" style="display:flex;gap:10px;flex-wrap:wrap;flex:1;">
      <div class="search-wrap">
        <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
        <input class="search-input" type="text" name="search" placeholder="Search title or code…" value="<?php echo e(request('search')); ?>">
      </div>
      ...
      <?php if(request('search') || request('status')): ?>
        <a href="<?php echo e(route('admin.promos.index')); ?>" style="padding:9px 14px;font-size:.82rem;color:rgba(59,42,26,.45);text-decoration:none;align-self:center;">Clear</a>
      <?php endif; ?>
    </form>
  </div>
...
<div class="panel">
  <div class="panel-head">
    <div class="panel-title-wrap">
      ...
      <span class="panel-count"><?php echo e($promos->total()); ?></span>
    </div>
  </div>

  <?php if($promos->isEmpty()): ?>
    <div class="empty">
  ...
  <table class="ptable">
    ...
    <tbody>
      ...
      <tr>
        <td>
          <div class="promo-name"><?php echo e($promo->title); ?></div>
          <?php if($promo->description): ?>
            <div class="promo-desc-cell"><?php echo e(Str::limit($promo->description, 50)); ?></div>
          <?php endif; ?>
        </td>
        <td>
          <span class="code-badge" onclick="copyCode('<?php echo e($promo->promo_code); ?>')">
        ...
        <td>
          <span class="discount-badge">
            <?php echo e($promo->discount_type === 'percentage' ? $promo->discount_value . '%' : '₱' . number_format($promo->discount_value, 2)); ?>

          </span>
        </td>
        <td><span class="pill pill-<?php echo e($status); ?>"><?php echo e(ucfirst($status)); ?></span></td>
        <td>
        ...
        <td>
          <div class="date-range">
            <strong><?php echo e($promo->start_date->format('M d')); ?></strong> – <strong><?php echo e($promo->end_date->format('M d, Y')); ?></strong>
          </div>
        </td>
        <td style="text-align:center;font-weight:700;color:var(--teal);">
          <?php echo e($promo->trips_count ?? 0); ?>

        </td>
        <td>
          <div class="actions" style="justify-content:flex-end">
            <a href="<?php echo e(route('admin.promos.show', $promo)); ?>" class="act-btn" title="View">
              <svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
            </a>
            <a href="<?php echo e(route('admin.promos.edit', $promo)); ?>" class="act-btn" title="Edit">
            ...
            <form method="POST" action="<?php echo e(route('admin.promos.destroy', $promo)); ?>" onsubmit="return confirm('Delete promo «<?php echo e($promo->title); ?>»?')">
  ...
  <?php if($promos->hasPages()): ?>
    <div class="pager"><?php echo e($promos->links()); ?></div>
  <?php endif; ?>
  <?php endif; ?>
</div>
