...
<?php $__env->startSection('page-title', 'Payment Receipt'); ?>
...
<div class="no-print action-bar">
  <a href="<?php echo e(route('bookings.show', $booking)); ?>" class="btn-back">
  ...
  <div class="receipt-body">
    ...
    <div class="ref-grid">
      <div class="ref-box">
        ...
        <div class="ref-val"><?php echo e($booking->payment->transaction_ref ?? 'N/A'); ?></div>
      </div>
      <div class="ref-box">
    ...
    <div class="field"><span class="field-label">Passenger</span><span class="field-value"><?php echo e($booking->user->name); ?></span></div>
    <div class="field"><span class="field-label">Email</span><span class="field-value"><?php echo e($booking->user->email); ?></span></div>
    <div class="field"><span class="field-label">Route</span><span class="field-value"><?php echo e($trip->origin_country ?? $trip->origin); ?> → <?php echo e($trip->destination_country ?? $trip->destination); ?></span></div>
    <div class="field"><span class="field-label">Operator</span><span class="field-value"><?php echo e($trip->operator ?? '—'); ?></span></div>
    <div class="field"><span class="field-label">Departure</span><span class="field-value"><?php echo e($dep->format('M d, Y · h:i A')); ?></span></div>
    <?php if($arr): ?><div class="field"><span class="field-label">Arrival</span><span class="field-value"><?php echo e($arr->format('M d, Y · h:i A')); ?></span></div><?php endif; ?>
    <div class="field"><span class="field-label">Duration</span><span class="field-value"><?php echo e($durStr); ?></span></div>
    <div class="field"><span class="field-label">Fare Class</span><span class="field-value"><?php echo e(ucfirst($schedule->fare_class ?? 'Economy')); ?></span></div>
    ...
    <div class="field"><span class="field-label">Method</span><span class="field-value"><?php echo e(ucfirst($booking->payment->method ?? '—')); ?></span></div>
    <div class="field"><span class="field-label">Status</span><span class="field-value teal">✓ Paid</span></div>
    <div class="field"><span class="field-label">Paid On</span><span class="field-value"><?php echo e($booking->payment->paid_at ? $booking->payment->paid_at->format('M d, Y h:i A') : '—'); ?></span></div>
    <div class="field"><span class="field-label">Passengers</span><span class="field-value"><?php echo e($booking->passenger_count); ?> pax</span></div>
    <?php if($booking->has_promo ?? false): ?>
      <div class="field"><span class="field-label">Original Amount</span><span class="field-value strike">₱<?php echo e(number_format($booking->original_amount ?? 0, 2)); ?></span></div>
      <div class="field"><span class="field-label">Promo (<?php echo e($booking->promo->promo_code ?? ''); ?>)</span><span class="field-value teal">−₱<?php echo e(number_format($booking->discount_amount ?? 0, 2)); ?></span></div>
    <?php endif; ?>

    <div class="total-row">
      <span class="total-label">Total Paid</span>
      <span class="total-val">₱<?php echo e(number_format($booking->total_amount, 2)); ?></span>
    </div>
  </div>
...
<div class="print-break">
  <div class="no-print tickets-label">
    <span class="tickets-badge">✈ <?php echo e($booking->tickets->count()); ?> Ticket(s)</span>
  </div>
  ...
  <div class="ticket-card">
    <div class="ticket-header-band">
      <div>
        ...
        <div class="ticket-issued"><?php echo e($ticket->issued_at ? $ticket->issued_at->format('M d, Y h:i A') : now()->format('M d, Y h:i A')); ?></div>
      </div>
      <span class="ticket-status-badge"><?php echo e(strtoupper($ticket->status ?? 'ISSUED')); ?></span>
    </div>

    <div class="ticket-body">
      <div class="ticket-route-row">
        <div class="tc-city">
          <div class="tc-code"><?php echo e($originCode); ?></div>
          <div class="tc-name"><?php echo e($trip->origin); ?></div>
          <div class="tc-time"><?php echo e($dep->format('h:i A')); ?></div>
          <div class="tc-date"><?php echo e($dep->format('M d, Y')); ?></div>
        </div>
        <div class="tc-divider">
          <div class="tc-dur"><?php echo e($durStr); ?></div>
        ...
        <div class="tc-city" style="text-align:right;">
          <div class="tc-code"><?php echo e($destCode); ?></div>
          <div class="tc-name"><?php echo e($trip->destination); ?></div>
          <div class="tc-time" style="color:var(--gold);"><?php echo e($arr ? $arr->format('h:i A') : '—'); ?></div>
          <div class="tc-date"><?php echo e($arr ? $arr->format('M d, Y') : '—'); ?></div>
        </div>
      </div>

      <div class="ticket-fields">
        <div><div class="tf-label">Passenger Name</div><div class="tf-val"><?php echo e($ticket->passenger_name); ?></div></div>
        <div><div class="tf-label">Booking Ref</div><div class="tf-val teal"><?php echo e($booking->reference_no); ?></div></div>
        <div><div class="tf-label">Fare Class</div><div class="tf-val"><?php echo e(ucfirst($ticket->fare_class ?? 'Economy')); ?></div></div>
        <div><div class="tf-label">Seat</div><div class="tf-val"><?php echo e($ticket->seat_no ?? 'Open Seating'); ?></div></div>
        <div><div class="tf-label">Operator</div><div class="tf-val"><?php echo e($trip->operator ?? '—'); ?></div></div>
        <div><div class="tf-label">Contact Email</div><div class="tf-val" style="font-size:.74rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><?php echo e($booking->contact_email); ?></div></div>
      </div>
      ...
      <div class="ticket-barcode">
        <div>
          ...
          <div class="barcode-lines">
            <?php $seed=crc32($ticket->ticket_no);$heights=[18,30,22,35,14,28,20,32,18,25,30,16,35,22,28,12,30,20,35,24]; ?>
            <?php $__currentLoopData = $heights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <span style="height:<?php echo e($h); ?>px;width:<?php echo e((($seed>>$i)&1)?3:2); ?>px;"></span>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          <div class="tkt-num"><?php echo e($ticket->ticket_no); ?></div>
        </div>
        <div style="text-align:right;">
          ...
          <div class="tkt-status">✓ <?php echo e(ucfirst($ticket->status ?? 'Issued')); ?></div>
          <div style="font-size:.68rem;color:rgba(59,42,26,.35);margin-top:5px;"><?php echo e($ticket->issued_at ? $ticket->issued_at->format('M d, Y') : now()->format('M d, Y')); ?></div>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AMVI User\OneDrive - Agata Mining Ventures\Desktop\laravel\otrs\resources\views/bookings/receipt.blade.php ENDPATH**/ ?>