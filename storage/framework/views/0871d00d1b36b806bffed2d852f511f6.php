...
<div class="edit-grid">
        ...
        <div class="f-row">
          <div class="f-group">
            ...
            <div class="field-error" id="pax-error">
              ...
              Only <strong style="margin:0 3px;"><?php echo e($booking->schedule->available_seats); ?></strong> seat(s) available.
            </div>
          </div>
          <div class="f-group">
  ...
  <div>
      ...
      <div class="panel-body">
        <div class="summary-box">
          ...
          <div class="s-row">
            ...
            <span class="s-v"><?php echo e($booking->schedule->trip->name); ?></span>
          </div>
          <div class="s-row">
            <span class="s-k">Route</span>
            <span class="s-v">
              <?php echo e($booking->schedule->trip->origin_country ?: $booking->schedule->trip->origin); ?>

              →
              <?php echo e($booking->schedule->trip->destination_country ?: $booking->schedule->trip->destination); ?>

            </span>
          </div>
          <div class="s-row">
            <span class="s-k">Departure</span>
            <span class="s-v"><?php echo e($booking->schedule->departure_at->format('M d, Y h:i A')); ?></span>
          </div>
          <div class="s-row">
            <span class="s-k">Fare Class</span>
            <span class="s-v"><?php echo e(ucfirst($booking->schedule->fare_class ?? 'Economy')); ?></span>
          </div>
          <div class="s-row">
            ...
            ?>
            <span class="s-v <?php echo e($seatsClass); ?>">
              <?php echo e($seats); ?>

              <?php if($seats <= 5): ?> &nbsp;⚠ Almost full
              <?php elseif($seats <= 20): ?> &nbsp;· Limited
              <?php endif; ?>
            </span>
          </div>
          <div class="s-row">
            <span class="s-k">Base Fare / pax</span>
            <span class="s-v">₱<?php echo e(number_format($booking->schedule->base_fare, 2)); ?></span>
          </div>
          <div class="s-row">
            <span class="s-k">Passengers</span>
            <span class="s-v" id="disp-pax"><?php echo e($booking->passenger_count); ?></span>
          </div>
          <div class="summary-total">
            <span class="total-label">New Total</span>
            <span class="total-value" id="disp-total">₱<?php echo e(number_format($booking->schedule->base_fare * $booking->passenger_count, 2)); ?></span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="btn-row">
      <a href="<?php echo e(route('bookings.show', $booking->id)); ?>" class="btn btn-cancel-act">
