...
class BookingController extends Controller
{
    ...
    public function update(Request $request, Booking $booking)
    {
        ...
        // Add back current booking's passengers so the user can increase/change their count fairly
        $availableSeats = $booking->schedule->available_seats + $booking->passenger_count;
    ...
    public function pay(Booking $booking)
    {
        ...
        if ($booking->payment()->where('status', 'paid')->exists()) {
